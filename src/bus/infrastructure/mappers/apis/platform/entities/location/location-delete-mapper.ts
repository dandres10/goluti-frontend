...
import { ILocationDeleteDTO } from "@bus/domain/models/apis/platform/entities/location";
import { ILocationDeleteEntity } from "@bus/infrastructure/entities/apis/platform/entities/location";

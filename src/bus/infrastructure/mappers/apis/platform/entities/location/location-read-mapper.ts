...
import { ILocationReadDTO } from "@bus/domain/models/apis/platform/entities/location";
import { ILocationReadEntity } from "@bus/infrastructure/entities/apis/platform/entities/location";

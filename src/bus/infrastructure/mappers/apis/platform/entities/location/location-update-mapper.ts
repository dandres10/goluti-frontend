...
import { ILocationUpdateDTO } from "@bus/domain/models/apis/platform/entities/location";
import { ILocationUpdateEntity } from "@bus/infrastructure/entities/apis/platform/entities/location";
